...
urlpatterns = [
    ...
    path('deletar_produto_empresa/<str:empresaID>',delete_produto_empresa, name="delete_produto_empresa"),
    path('editar_produto_empresa/<str:empresaID>',produtoEditar, name="produtoEditar"),
    #------------------------Rotas de API-------------------------------------------------------
